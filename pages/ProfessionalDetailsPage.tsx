    ...
    return (
        <motion.div {...motionProps} className="h-full flex flex-col bg-slate-50">
            <header className="flex items-center p-4 border-b border-slate-200 flex-shrink-0 bg-white/80 backdrop-blur-sm sticky top-0 z-10">
                ...
                <h1 className="text-xl font-bold text-slate-800 mx-auto pr-8">Perfil do Especialista</h1>
            </header>
            <main className="flex-grow overflow-y-auto p-6 space-y-6">
                <div className="flex flex-col items-center text-center space-y-3">
                    ...
                    <div>
                        ...
                        <p className="text-md text-indigo-500 font-semibold">{professional.specialty}</p>
                    </div>
                </div>
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm text-left">
                    <h3 className="font-bold text-lg text-slate-800 mb-2">Sobre</h3>
                    <p className="text-slate-600 whitespace-pre-line leading-relaxed">{professional.bio}</p>
                </div>
