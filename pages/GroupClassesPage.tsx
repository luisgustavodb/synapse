        ...
        <motion.div {...motionProps} className="h-full flex flex-col bg-slate-50">
            <header className="flex-shrink-0 bg-white/80 backdrop-blur-sm sticky top-0 z-20">
                <div className="flex items-center p-4 border-b border-slate-200">
                    ...
                    <h1 className="text-xl font-bold text-slate-800 mx-auto pr-8">Aulas Coletivas</h1>
                </div>
            </header>
            ...
            <div className="p-4 space-y-4 flex-shrink-0 bg-white border-b border-slate-200 sticky top-[65px] z-10">
                <button
                    ...
                    className="w-full flex justify-between items-center bg-slate-100 p-3 rounded-lg hover:bg-slate-200 transition-colors"
                >
                    <div>
                        <p className="text-xs text-slate-500 font-semibold">REGIÃO</p>
                        <p className="text-slate-800 font-bold">{selectedStateLabel}</p>
                    </div>
                    <ChevronRightIcon className="h-5 w-5 text-slate-400" />
                </button>
                <div className="space-y-3">
                    <div>
                        <h2 className="text-xs font-bold text-slate-500 mb-2 px-1">PERÍODO</h2>
                    ...
                    <div>
                        <h2 className="text-xs font-bold text-slate-500 mb-2 px-1">FAIXA ETÁRIA</h2>
                        <div className="flex items-center space-x-2">
                     ...
                     {filteredClasses.length > 0 ? (
                        <motion.div layout className="grid grid-cols-1 gap-6">
                         ...
                         <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center pt-16">
                            ...
                            <h3 className="mt-4 text-lg font-bold text-slate-700">Nenhuma aula encontrada</h3>
