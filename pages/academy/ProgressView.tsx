...
const GoalCard: React.FC<{ goal: Goal; onClick: () => void; }> = ({ goal, onClick }) => {
    ...
    return (
        <button
            onClick={onClick}
            className="w-full text-left p-4 border border-slate-200 bg-white hover:bg-slate-100/50 transition-colors rounded-xl"
        >
        ...
        <div className="p-6 space-y-8 pb-24">
            ...
            <section>
                ...
                <button
                    ...
                    className="w-full text-left p-4 h-64 border rounded-2xl border-slate-200 bg-white hover:bg-slate-50 active:scale-[0.98] transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-indigo-300"
            ...
            <section>
             ...
             <section>
                 <h2 className="text-xl font-bold text-slate-800 mb-4">Trilha de Conquistas</h2>
