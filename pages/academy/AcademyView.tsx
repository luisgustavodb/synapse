  ...
  return (
    <div className="bg-white min-h-full pb-16">
        <div className="pt-6 space-y-8">
            ...
            <div className="px-6">
                <section>
                    <h2 className="text-lg font-semibold text-slate-800 mb-3">Academia</h2>
                    <Link to="/workouts" className="block relative rounded-xl overflow-hidden h-44 group">
            ...
            <section className="space-y-3 w-full">
                <div className="flex justify-between items-center mb-1 px-6">
                    ...
                    <Link to="/group-classes" className="text-sm font-semibold text-indigo-600 hover:text-indigo-500">Ver todas</Link>
                </div>
                <div
                ...
                >
                    <div className="flex space-x-4 px-6 pb-2 snap-x snap-mandatory select-none">
                        ...
                        <Link to={`/group-class/${c.id}`} key={c.id} draggable="false" className="flex-shrink-0 w-36 h-48 relative rounded-xl overflow-hidden group snap-start">
