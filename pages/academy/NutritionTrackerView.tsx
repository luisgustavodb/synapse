    ...
    <div className="bg-white p-4 rounded-2xl shadow-sm">
        <div className="flex items-center space-x-3 mb-3">
            ...
            <div>
                ...
                <p className="font-bold text-slate-800 text-lg">{value} <span className="text-sm font-medium text-slate-500">{label}</span></p>
            </div>
        </div>
        <div className="h-28">
            {children}
...
const NutritionTrackerView: React.FC = () => {
    return (
        <div className="bg-slate-50 p-6 pt-2 space-y-6 pb-24">
                ...
                >
                    <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={weeklyWaterData} margin={{ top: 10, right: 10, left: -25, bottom: 0 }}>
                            <XAxis dataKey="day" tickLine={false} axisLine={false} tick={{ fontSize: 10, fill: 'rgb(100, 115, 139)' }} dy={5} />
                            <YAxis axisLine={false} tickLine={false} tick={{ fontSize: 10, fill: 'rgb(100, 115, 139)' }} />
            ...
            <section className="bg-white p-4 rounded-2xl shadow-sm">
                 <h2 className="text-lg font-bold text-slate-800 mb-4 text-center">Calorias e Macros</h2>
             ...
             <section>
                <h2 className="text-lg font-bold text-slate-800 mb-3">Refeições</h2>
