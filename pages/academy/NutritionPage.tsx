        ...
        return (
            <button
                ...
                className={`w-full rounded-full py-2.5 text-sm font-bold transition-colors ${
                    isActive ? 'bg-white text-indigo-600 shadow-sm' : 'text-slate-500 hover:bg-slate-200/50'
                }`}
            >
                {label}
            </button>
    ...
    return (
        <div className="h-full">
            <div className="p-4 pt-6 bg-slate-50">
                <div className="bg-slate-200 p-1 rounded-full grid grid-cols-2 gap-1 max-w-sm mx-auto">
