...
const PsychologistsPage: React.FC = () => {
  ...
  return (
    ...
    >
      <header className="p-6 pb-2 text-center sticky top-0 bg-white z-10 flex-shrink-0">
        <h1 className="text-3xl font-bold text-slate-800">Todos os Especialistas</h1>
      </header>

      <nav className="px-2 sm:px-4 py-2 sticky top-[72px] bg-white z-10 flex-shrink-0">
          <div 
