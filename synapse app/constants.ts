...
export const feedPosts: FeedPost[] = [
  {
    id: 'post1',
    type: 'post',
    author: { name: 'Laura Martins', handle: '@lauramartins', avatar: 'https://i.pravatar.cc/150?img=49' },
  ...
  },
  {
    id: 'post3',
    type: 'ad',
    author: { name: 'Synapse Ads', handle: '@synapse_ads', avatar: '🧠' },
    imageUrl: 'https://img.freepik.com/free-psd/landing-page-fashion-collection-template_23-2148645269.jpg?semt=ais_hybrid&w=740&q=80',
    caption: 'Sua jornada para uma mente mais calma começa aqui. Baixe nosso guia gratuito de meditação. #BemEstar #SynapseApp',
    likes: 0,
    comments: 0,
  },
  {
  ...
  },
  {
    id: 'post5',
    type: 'post',
    author: { name: 'Beatriz Lima', handle: '@bialima', avatar: 'https://i.pravatar.cc/150?img=40' },
    imageUrl: 'https://images.unsplash.com/photo-1532012197267-da84d127e765?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=400',
  ...
  },
  {
    id: 'post6',
    type: 'post',
    author: { name: 'Rafael Souza', handle: '@rafasouza', avatar: 'https://i.pravatar.cc/150?img=15' },
  ...
  },
  {
    id: 'post7',
    type: 'ad',
    author: { name: 'Healthy Eats', handle: '@healthy_eats', avatar: '🥗' },
    imageUrl: 'https://static.vecteezy.com/system/resources/previews/041/955/546/non_2x/minimalist-business-promotional-social-media-and-web-ads-banner-template-with-image-placeholder-vector.jpg',
    caption: 'Cansado de cozinhar? Receba refeições saudáveis e deliciosas na sua porta. Use o código SYNAPSE10 para 10% de desconto!',
    likes: 0,
    comments: 0,
  },
  {
  ...
  },
  {
    id: 'post9',
    type: 'post',
    author: { name: 'Lucas Pereira', handle: '@lucasp', avatar: 'https://i.pravatar.cc/150?img=14' },
  ...
  },
  {
    id: 'post10',
    type: 'post',
    author: { name: 'Sofia Mendes', handle: '@sofiamendes', avatar: 'https://i.pravatar.cc/150?img=32' },
  ...
  },
  {
    id: 'post11',
    type: 'post',
    author: { name: 'Gabriel Almeida', handle: '@galmeida', avatar: 'https://i.pravatar.cc/150?img=33' },
  ...
  },
  {
    id: 'post13',
    type: 'post',
    author: { name: 'Carlos Andrade', handle: '@carlos_andrade', avatar: 'https://i.pravatar.cc/150?img=12' },
  ...
  },
  {
    id: 'post14',
    type: 'post',
    author: { name: 'Ana Clara Santos', handle: '@anacsantos', avatar: 'https://i.pravatar.cc/150?img=20' },
  ...
  },
  {
    id: 'post15',
    type: 'post',
    author: { name: 'Tiago Barros', handle: '@tiagobarros', avatar: 'https://i.pravatar.cc/150?img=63' },
    imageUrl: 'https://images.unsplash.com/photo-1511379938547-c1f69419868d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3wzOTAwNXwwfDF8c2VhcmNofDN8fG11c2ljfGVufDB8fHx8fDE3MjAzMjU4Nzh8MA&ixlib=rb-4.0.3&q=80&w=400',
  ...
  },
  {
    ...
    type: 'post',
    author: userAuthor,
    imageUrl: 'https://images.unsplash.com/photo-1476231682828-37e571bc172f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3wzOTAwNXwwfDF8c2VhcmNofDh8fG1vdW50YWlufGVufDB8fHx8fDE3MjAzMjU5Nzd8MA&ixlib=rb-4.0.3&q=80&w=400',
  ...
  },
  {
    id: 'post17',
    type: 'post',
    author: { name: 'Juliana Costa', handle: '@jucosta', avatar: 'https://i.pravatar.cc/150?img=26' },
...
export const userStories: Story[] = [
    {
        id: 'story1',
        imageUrl: feedPosts.find(p => p.id === 'post16')!.imageUrl,
        user: storyUser,
        timestamp: '2h'
    },
    {
        id: 'story2',
        imageUrl: feedPosts.find(p => p.id === 'post4')!.imageUrl,
        user: storyUser,
        timestamp: '1h'
    }
];
...
export const storyHighlights: StoryHighlight[] = [
  {
    id: 'hl1',
    label: 'Viagens',
    coverUrl: 'https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=200',
    stories: [
        { id: 's1-1', imageUrl: 'https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800', user: storyUser, timestamp: '1d' },
        { id: 's1-2', imageUrl: 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800', user: storyUser, timestamp: '2d' },
        { id: 's1-3', imageUrl: 'https://images.unsplash.com/photo-1476231682828-37e571bc172f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800', user: storyUser, timestamp: '3d' },
    ]
  },
  {
    id: 'hl2',
    label: 'Comida',
    coverUrl: 'https://images.unsplash.com/photo-1498837167922-ddd27525d352?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=200',
    stories: [
        { id: 's2-1', imageUrl: 'https://images.unsplash.com/photo-1498837167922-ddd27525d352?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800', user: storyUser, timestamp: '4h' },
        { id: 's2-2', imageUrl: 'https://images.unsplash.com/photo-1490645935967-10de6ba17021?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800', user: storyUser, timestamp: '8h' },
    ]
  },
   {
    id: 'hl3',
    label: 'Fitness',
    coverUrl: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=200',
    stories: [
        { id: 's3-1', imageUrl: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800', user: storyUser, timestamp: '5d' },
        { id: 's3-2', imageUrl: 'https://images.unsplash.com/photo-1517836357463-d25dfeac3438?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800', user: storyUser, timestamp: '6d' },
    ]
  },
];
...
export const groupClasses: GroupClass[] = [
  ...
  { 
      ...
      time: 'QUA, 20H', 
      imageUrl: 'https://images.unsplash.com/photo-1593509939522-26a9437146d5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=400',
      region: 'SP',
      period: 'Noite',
      ageRange: '18-25',
