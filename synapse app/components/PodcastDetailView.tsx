            ...
            <main className="flex-grow overflow-y-auto p-6 space-y-6">
                <section className="flex flex-col items-center text-center space-y-4">
                     <motion.img 
                        ...
                        alt={podcast.title} 
                        className="w-48 h-48 rounded-2xl object-cover shadow-2xl shadow-slate-400/50 dark:shadow-slate-950/50" 
                     />
                    <div>
                ...
                <section>
                    ...
                    <form onSubmit={handleAddComment} className="flex items-center space-x-2 mb-4">
                        <img src={user.avatarUrl} alt="Seu avatar" className="w-9 h-9 rounded-full"/>
                        <input 
                            type="text" 
