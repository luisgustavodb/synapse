...
const ArticleCard: React.FC<ArticleCardProps> = ({ article }) => {
    ...
    return (
        <ReactRouterDOM.Link to={`/detail/article/${id}`} className="p-4 flex items-center space-x-4 transition-colors hover:bg-slate-100/50 dark:hover:bg-slate-800/50 cursor-pointer border-b border-slate-200 dark:border-slate-700">
