        ...
        <div className="h-full flex flex-col bg-slate-950 text-white">
            ...
            <main className="flex-grow flex items-center justify-center relative min-h-0">
                <AnimatePresence initial={false} custom={direction}>
                 ...
                 <button 
                    onClick={() => paginate(-1)}
                    className="absolute left-2 top-1/2 -translate-y-1/2 bg-slate-900/40 p-1.5 rounded-full text-white hover:bg-slate-900/70 transition-colors"
                ...
                <button 
                    onClick={() => paginate(1)}
                    className="absolute right-2 top-1/2 -translate-y-1/2 bg-slate-900/40 p-1.5 rounded-full text-white hover:bg-slate-900/70 transition-colors"
