...
const HomePage: React.FC = () => {
    ...
    return (
        <MotionDiv
            {...motionProps}
        >
            <div className="fixed top-0 left-1/2 -translate-x-1/2 w-full max-w-md z-20 bg-slate-100/80 dark:bg-slate-900/80 backdrop-blur-sm border-b border-slate-200 dark:border-slate-700 h-[68px]">
                    ...
                    {isSearchOpen ? (
                        ...
                        >
                            ...
                            <button 
                                ...
                                className="text-sm font-semibold text-slate-600 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-indigo-400 p-2 flex-shrink-0"
                            >
                                Cancelar
                            </button>
                        </MotionDiv>
                        ...
                        >
                            <h1 className="text-2xl font-bold text-slate-800 dark:text-slate-200 tracking-tighter">Synapse</h1>
