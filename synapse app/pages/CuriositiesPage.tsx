        ...
        <MotionDiv {...motionProps} className="h-full flex flex-col bg-slate-50">
            <header className="flex-shrink-0 bg-white/80 backdrop-blur-sm sticky top-0 z-20">
                <div className="flex items-center p-4 border-b border-slate-200">
                    ...
                    <h1 className="text-xl font-bold text-slate-800 mx-auto pr-8">Curiosidades</h1>
                </div>
            </header>
                        ...
                        >
                         ...
                         >
                            <div className="inline-block p-4 bg-slate-200 rounded-full">
                                <LightBulbIcon className="h-10 w-10 text-slate-400" />
                            </div>
                            <h3 className="mt-4 text-lg font-bold text-slate-700">Nenhum item encontrado</h3>
