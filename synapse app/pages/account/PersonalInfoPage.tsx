      ...
      <main className="flex-grow overflow-y-auto p-6 space-y-6">
        ...
        <form className="space-y-4" onSubmit={handleSave}>
            ...
            <div>
                ...
                <input type="email" id="email" defaultValue="alex.rivera@email.com" readOnly className="w-full bg-slate-200 dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded-xl py-3 px-4 text-slate-800 dark:text-slate-300 text-sm" />
            </div>
             <div>
                <label htmlFor="dob" className="block text-sm font-medium text-slate-500 dark:text-slate-400 mb-1">Data de Nascimento</label>
                <input type="text" id="dob" defaultValue="15 de Maio, 1998" readOnly className="w-full bg-slate-200 dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded-xl py-3 px-4 text-slate-800 dark:text-slate-300 text-sm" />
            </div>
            <div className="pt-4">
