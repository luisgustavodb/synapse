                 ...
                 <div className="w-full text-center space-y-4">
                    ...
                    <p className="text-slate-500 dark:text-slate-400">Versão 1.0.0 (Build 2025)</p>
                     <div className="text-indigo-600 dark:text-indigo-400 text-sm font-semibold space-x-4">
                        <ReactRouterDOM.Link to="/terms-of-service" className="hover:underline">Termos de Serviço</ReactRouterDOM.Link>
                        <ReactRouterDOM.Link to="/privacy-policy" className="hover:underline">Política de Privacidade</ReactRouterDOM.Link>
                     </div>
                </div>
            );
        default:
