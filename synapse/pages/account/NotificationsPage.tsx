    ...
    return (
        <div className="flex items-center justify-between">
            <div className="flex-grow">
                <label htmlFor={toggleId} className="font-semibold text-slate-800 block cursor-pointer">{label}</label>
            ...
            <div className="relative inline-block w-11 mr-2 align-middle select-none transition duration-200 ease-in">
                <input 
                    ...
                    className={`absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none cursor-pointer transition-all duration-200 ${isChecked ? 'right-0 border-slate-800' : 'border-slate-300'}`}
                    style={{
                ...
                <label 
                    htmlFor={toggleId} 
                    className={`block overflow-hidden h-6 rounded-full cursor-pointer transition-colors duration-200 ${isChecked ? 'bg-slate-800' : 'bg-slate-300'}`}
                ></label>
            </div>
        </div>
    );
    ...
    return (
        ...
        >
            <header className="flex items-center p-4 border-b border-slate-200 flex-shrink-0">
                ...
                <h1 className="text-xl font-bold text-slate-800 mx-auto pr-8">Notificações</h1>
            </header>
            <main className="flex-grow overflow-y-auto p-6 space-y-8">
                <div className="bg-white rounded-3xl shadow-md p-5">
                    <h2 className="text-lg font-bold text-slate-800 mb-4">Configurações de Push</h2>
                    <div className="space-y-4 divide-y divide-slate-100 -mt-2">
                        <div className="pt-4">
                ...
                <div >
                    <h2 className="text-lg font-bold text-slate-800 mb-4">Recentes</h2>
                     <div className="bg-white rounded-3xl shadow-md p-5 space-y-5 divide-y divide-slate-100">
