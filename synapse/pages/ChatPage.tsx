...
const ChatPage: React.FC = () => {
    ...
    return (
        ...
        >
            <header className="text-center p-6 border-b border-slate-200 flex-shrink-0">
              <h1 className="text-2xl font-bold text-slate-800">Chat IA</h1>
              <p className="text-sm text-pink-500">Seu companheiro de bem-estar pessoal</p>
            </header>
            ...
            <div className="flex-grow p-4 space-y-4 overflow-y-auto">
                ...
                {isLoading && (
                    <div className="flex justify-start">
                        <div className="bg-slate-200 text-slate-800 rounded-2xl px-4 py-3 shadow-sm rounded-bl-none">
            ...
            <footer className="p-4 bg-white/80 backdrop-blur-sm border-t border-slate-200 flex-shrink-0">
                <form onSubmit={handleSend} className="flex items-center space-x-2">
                    <input
                        ...
                        className="flex-grow bg-slate-100 border border-slate-300 rounded-full py-3 px-4 focus:outline-none focus:ring-2 focus:ring-pink-400 text-slate-800 text-sm"
