...
const WeeklyMoodCard: React.FC = () => {
  return (
    <div className="rounded-3xl p-6 shadow-md bg-white">
      <div className="flex justify-between items-start mb-4">
        <div>
          <h2 className="text-sm font-medium text-slate-500">Humor Semanal</h2>
      ...
      <div className="h-40">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={weeklyMoodData} margin={{ top: 5, right: 20, left: -20, bottom: -10 }}>
            ...
            <XAxis dataKey="day" tickLine={false} axisLine={false} tick={{ fontSize: 12, fill: 'rgb(100, 115, 139)' }} dy={10} />
