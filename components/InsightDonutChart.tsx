...
const InsightDonutChart: React.FC<InsightDonutChartProps> = ({ insight }) => {
    ...
    return (
        <div className="rounded-2xl p-3 border border-slate-200 flex flex-col items-center text-center h-full">
            <h3 className="text-xs font-semibold text-slate-500 mb-1">{insight.title}</h3>
            ...
            <p className="text-xs text-slate-500 mt-1">{insight.label}</p>
        </div>
    );
};
