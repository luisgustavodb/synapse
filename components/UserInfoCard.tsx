        ...
        <div className="bg-white rounded-2xl shadow-md p-5">
            <div className="flex items-start justify-between mb-4">
                <div className="flex items-center space-x-4">
                 ...
                 <Link to="/settings" className="text-slate-500 hover:text-slate-800 p-2 -mr-2 -mt-1">
                    <SettingsIcon className="h-5 w-5"/>
                </Link>
            </div>

            <p className="text-sm text-slate-600 whitespace-pre-line mb-4">{user.bio}</p>

            <div className="grid grid-cols-3 gap-2 border-t border-b border-slate-200 py-3">
            ...
            <div className="flex items-center space-x-2 mt-4">
                <button 
                    ...
                    className="flex-1 bg-slate-800 hover:bg-slate-700 text-white text-sm font-semibold py-2 px-4 rounded-lg transition-colors flex items-center justify-center space-x-2"
                >
                    <PencilIcon className="h-4 w-4" />
                    <span>Editar Perfil</span>
                </button>
                <button className="flex-1 bg-slate-200 hover:bg-slate-300 text-slate-800 text-sm font-semibold py-2 px-4 rounded-lg transition-colors flex items-center justify-center space-x-2">
