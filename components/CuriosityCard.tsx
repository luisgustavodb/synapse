...
const CuriosityCard: React.FC<{ curiosity: Article; index: number }> = ({ curiosity, index }) => {
    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 bg-cover bg-center opacity-10 group-hover:opacity-20 transition-opacity" style={{ backgroundImage: `url(${curiosity.imageUrl})` }}></div>
