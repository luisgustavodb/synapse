...
const RecipeCard: React.FC<RecipeCardProps> = ({ recipe }) => {
    ...
    return (
        <Link to={`/detail/activity/${recipe.id}`} className="block group bg-white rounded-2xl shadow-sm overflow-hidden transition-all duration-300 hover:shadow-md hover:-translate-y-1">
